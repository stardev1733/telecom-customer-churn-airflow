...
args = {
    "project_id": "Airflow-Testing-Vedrats-0818092417",
}


dag = DAG(
    "Airflow-Testing-Vedrats-0818092417",
    default_args=args,
...
op_88b2b882_1830_4a1c_b000_7cf8717cb6d1 = KubernetesPodOperator(
    ...
    secrets=[
        ...
        Secret("env", "AWS_S3_BUCKET", "aws-connection-vedrats-minio", "AWS_S3_BUCKET"),
        Secret(
            "env", "AWS_S3_ENDPOINT", "aws-connection-vedrats-minio", "AWS_S3_ENDPOINT"
        ),
        Secret(
            "env",
            "AWS_SECRET_ACCESS_KEY",
...
op_2110e1eb_b163_40cc_8079_0d0d2d5209a2 = KubernetesPodOperator(
    ...
    cmds=["sh", "-c"],
    arguments=[
        "mkdir -p ./jupyter-work-dir/ && cd ./jupyter-work-dir/ && echo 'Downloading file:///opt/app-root/lib/python3.8/site-packages/elyra/kfp/bootstrapper.py' && curl --fail -H 'Cache-Control: no-cache' -L file:///opt/app-root/lib/python3.8/site-packages/elyra/kfp/bootstrapper.py --output bootstrapper.py && echo 'Downloading file:///elyra-deps/requirements-elyra.txt' && echo 'Downloading file:///elyra-deps/requirements-elyra-py37.txt' && curl --fail -H 'Cache-Control: no-cache' -L file:///elyra-deps/requirements-elyra-py37.txt --output requirements-elyra-py37.txt && curl --fail -H 'Cache-Control: no-cache' -L file:///elyra-deps/requirements-elyra.txt --output requirements-elyra.txt && python3 -m pip install packaging && python3 -m pip freeze > requirements-current.txt && python3 bootstrapper.py --pipeline-name 'Airflow-Testing-Vedrats' --cos-endpoint http://s3.apps.vedrats.sl --cos-bucket openshift-ai-test --cos-directory 'Airflow-Testing-Vedrats-0818092417' --cos-dependencies-archive 'model_randomforest-2110e1eb-b163-40cc-8079-0d0d2d5209a2.tar.gz' --file 'telecom-customer-churn-airflow/include/notebooks/model_randomforest.ipynb' "
    ],
...
op_0f4eb44c_1535_4509_b63d_94c2bf291be0 = KubernetesPodOperator(
    ...
    cmds=["sh", "-c"],
    arguments=[
        "mkdir -p ./jupyter-work-dir/ && cd ./jupyter-work-dir/ && echo 'Downloading file:///opt/app-root/lib/python3.8/site-packages/elyra/kfp/bootstrapper.py' && curl --fail -H 'Cache-Control: no-cache' -L file:///opt/app-root/lib/python3.8/site-packages/elyra/kfp/bootstrapper.py --output bootstrapper.py && echo 'Downloading file:///elyra-deps/requirements-elyra.txt' && echo 'Downloading file:///elyra-deps/requirements-elyra-py37.txt' && curl --fail -H 'Cache-Control: no-cache' -L file:///elyra-deps/requirements-elyra-py37.txt --output requirements-elyra-py37.txt && curl --fail -H 'Cache-Control: no-cache' -L file:///elyra-deps/requirements-elyra.txt --output requirements-elyra.txt && python3 -m pip install packaging && python3 -m pip freeze > requirements-current.txt && python3 bootstrapper.py --pipeline-name 'Airflow-Testing-Vedrats' --cos-endpoint http://s3.apps.vedrats.sl --cos-bucket openshift-ai-test --cos-directory 'Airflow-Testing-Vedrats-0818092417' --cos-dependencies-archive 'model_gradient_boost-0f4eb44c-1535-4509-b63d-94c2bf291be0.tar.gz' --file 'telecom-customer-churn-airflow/include/notebooks/model_gradient_boost.ipynb' "
    ],
...
op_d56998f4_b37b_4203_a81f_44ae7709c1fa = KubernetesPodOperator(
    ...
    cmds=["sh", "-c"],
    arguments=[
        "mkdir -p ./jupyter-work-dir/ && cd ./jupyter-work-dir/ && echo 'Downloading file:///opt/app-root/lib/python3.8/site-packages/elyra/kfp/bootstrapper.py' && curl --fail -H 'Cache-Control: no-cache' -L file:///opt/app-root/lib/python3.8/site-packages/elyra/kfp/bootstrapper.py --output bootstrapper.py && echo 'Downloading file:///elyra-deps/requirements-elyra.txt' && echo 'Downloading file:///elyra-deps/requirements-elyra-py37.txt' && curl --fail -H 'Cache-Control: no-cache' -L file:///elyra-deps/requirements-elyra-py37.txt --output requirements-elyra-py37.txt && curl --fail -H 'Cache-Control: no-cache' -L file:///elyra-deps/requirements-elyra.txt --output requirements-elyra.txt && python3 -m pip install packaging && python3 -m pip freeze > requirements-current.txt && python3 bootstrapper.py --pipeline-name 'Airflow-Testing-Vedrats' --cos-endpoint http://s3.apps.vedrats.sl --cos-bucket openshift-ai-test --cos-directory 'Airflow-Testing-Vedrats-0818092417' --cos-dependencies-archive 'compare_and_push-d56998f4-b37b-4203-a81f-44ae7709c1fa.tar.gz' --file 'telecom-customer-churn-airflow/include/notebooks/compare_and_push.ipynb' "
    ],
